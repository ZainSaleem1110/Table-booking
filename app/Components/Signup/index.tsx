...
function Signup({ show, onClose, openLogin }: any) {
                    ...
                    <div className="flex flex-col gap-4 w-full">
                      ...
                      <div className="pb-8 flex flex-col gap-4 text-[#003b95] w-full">
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <p className="text-[14px] text-black mt-0 pt-0">
                            I agree to the{" "}
                            <span className="text-[#003b95] cursor">Privacy Policy</span> and{" "}
                            <span className="text-[#003b95] cursor">Terms and Conditions.</span>
                          </p>
                        </div>
